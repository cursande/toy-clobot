...
;; TODO: Maybe representing the robot/coords with something like an atom would be better..?
...
(def commands (-> "test/fixtures/instructions.txt"
                  (slurp)
                  (split-lines)))
